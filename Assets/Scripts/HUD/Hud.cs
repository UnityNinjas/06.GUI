...
public class Hud : MonoBehaviour
{
    ...
    public BetweenAlpha immobilizer;
    public BetweenPosition mediaPlayerTransition;
    public BetweenPosition progressSliderTransition;
    ...
    {
        this.mediaPlayerTransition.PlayReverse();
        this.progressSliderTransition.PlayReverse();
        this.immobilizer.PlayReverse();
    }
}